export default {
  ...
  项目名称_: 'Project Name',
  一旦删除该项目操作将无法撤销请谨慎操作: 'Once deleted, this operation cannot be undone, please proceed with caution.',
  ...
  一旦删除该环境操作将无法撤销请谨慎操作: 'Once deleted, this operation cannot be undone, please proceed with caution.',
