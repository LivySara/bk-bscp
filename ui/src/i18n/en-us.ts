export default {
  ...
  所属项目: 'Subordinate Project',
  所属环境: 'Subordinate Environment',
  '请选择业务/项目': 'Please select a business/project',
  请选择项目: 'Please select a project',
  请先选择业务: 'Please select a business first',
  请先选择项目: 'Please select a project first',
  请选择环境: 'Please select an environment',
  暂无项目: 'No projects available',
  服务将创建到以下项目和环境下: 'The service will be created under the following project and environment',
  ...
  tips: {
    ...
    type: `arbitrary format: The format of the config item is not restricted. If you select one of the following format, only config items of the specified type can be created
  ...
  '该服务下存在非{n}类型的配置项，如需修改，请先调整该服务下的所有配置项数据格式为{n}': 'There are config items of non-{n} type under this service. If you need to modify it, please adjust the data format of all config items under this service to {n} first',
  或签: 'or sign',
  会签: 'count sign',
  ...
  '或签：多人同时审批，一人同意即可通过n会签：审批人依次审批，每人都需同意才能通过': 'Or sign: Multiple approvers can approve simultaneously, and approval is granted as soon as one person agrees\nCount sign: Approvers must approve sequentially, and all must agree for approval to be granted',
  关闭上线审批存在风险: 'Disabling the approval process for production deployment carries risks',
  生产环境不建议关闭审批: 'It is not recommended to disable the approval process in the production environment',
  审批流程可以提高配置更改的准确性和安全性: 'The approval process can enhance the accuracy and security of config changes',
  仍要关闭: 'Cancel',
  ...
  环境数: 'Environments',
  服务点数: 'Services',
  搜索业务: 'Search business',
  搜索项目: 'Name',
  确认删除该项目: 'Are you sure to delete this project?',
  项目名称_: 'Project Name',
  删除项目成功: 'Project deleted successfully.',
  编辑项目成功: 'Project updated successfully.',
  创建项目成功: 'Project created successfully.',
  请输入项目名称: '  Please enter the project name',
  '项目名称/项目描述/创建人': 'Name / Description / Creator',
  '删除该项目后将无法恢复，请谨慎操作': 'Once the project is deleted, it cannot be recovered. Please proceed with caution.',
  ...
  环境描述: 'Description',
  共N个服务: '{count} Services',
  搜索环境: 'Name / Description / Creator',
  生产环境: 'Production',
  预发布环境: 'Staging',
  测试环境: 'Testing',
  开发环境: 'Development',
  暂无N: 'No {type}',
  确认删除该环境: 'Are you sure to delete this environment?',
  删除环境成功: 'Environment deleted successfully.',
  编辑环境成功: 'Environment updated successfully.',
  创建环境成功: 'Environment created successfully.',
  请输入环境名称: 'Please enter the environment name',
  请输入环境描述: 'Please enter the environment description',
  环境名称只能包含英文字母: 'Environment name can only contain English letters',
  环境不能为空: 'Environment cannot be empty',
  '环境名称/环境描述/创建人': 'Name / Description / Creator',
  '删除该环境后将无法恢复，请谨慎操作': 'Once the environment is deleted, it cannot be recovered. Please proceed with caution.',
  '当前处于生产环境的配置管理，请谨慎操作以避免影响线上业务！': 'You are currently in the production environment configuration management. Please operate with caution to avoid affecting online services!',
  '当前处于预发布环境的配置管理，与生产环境高度一致，请按生产标准进行验证！': 'You are currently in the staging environment configuration management, which is highly consistent with the production environment. Please verify according to production standards!',
  '当前处于测试环境的配置管理，仅用于功能测试验证，数据可能会重置。': 'You are currently in the testing environment configuration management, which is only used for functional testing and verification. Data may be reset.',
  '当前处于开发环境的配置管理，用于开发调试，服务可能不稳定。': 'You are currently in the development environment configuration management, which is used for development and debugging. Services may be unstable.',
  ...
  已上线: 'Released',
  操作: 'Operations',
  只支持未上线和未待审批版本: 'Only supports unreleased and pending approval versions',
  恢复: 'Restore',
  删除: 'Delete',
  版本详情: 'Version Details',
  '配置文件名/创建人/修改人': 'Config file name / Creator / Reviser',
  '配置项名称/创建人/修改人': 'Config item name / Creator / Reviser',
  ...
  '需审批-定时上线文案': 'Once the approval for deployment is granted, the version will be released in {time}',
  '定时上线文案-调整分组': 'Adjustment group version will take effect at {time}',
  '需审批-定时上线文案-调整分组': 'Once the approval for deployment is granted, the version with the adjusted grouping will take effect in {time}',
  ...
  配置版本名称: 'Config version name',
  配置上线范围: 'Config publish scope',
  去审批: 'Go to approval',
  审批: 'Approval',
  审批人: 'Approver',
  撤销人: 'Revoker',
  ...
  操作成功: 'Success',
  高频上线风险提示: 'High-Frequency Release Risk Notice',
  '当前服务有正在上线的任务，请稍后尝试': 'There are tasks being released at the moment. Please try again later',
  近三次版本上线记录: 'Records of the last three version releases',
  查看全部上线记录: 'View all release records',
  上线时间: 'Release time',
  '正在上线的版本：': 'The version in the process of going live：',
  继续上线: 'Continue',
  再想想: 'Cancel',
  近num天: 'Within {day} days',
  上线审批: 'approval',
  ...
  无确认上线权限文案: 'Please contact the service go-live submitter, {creator}, for confirmation of the go-live operation\nIf you are unable to reach the submitter and there are urgent configs that need to be published\nyou may perform a revoke go-live and then resubmit the service go-live process',
  '进行确认上线操作。': 'for confirmation of the go-live operation',
  '如果无法联系到提交人，并且有紧急配置需要发布，可以执': 'If you are unable to reach the submitter and there are urgent configs that need to be published',
  '行“撤销上线”后重新提交服务上线流程': 'you may perform a revoke go-live and then resubmit the service go-live process',
  请联系服务上线提交人: 'Please contact the service go-live submitter',
  ...
  批量恢复: 'Batch restore',
  批量恢复配置文件成功: 'Batch restore config file successfully',
  批量恢复配置项成功: 'Batch restore config item successfully',
  '确认恢复所选的 {n} 个配置文件？': 'Confirm to restore the selected {n} config files?',
  '确认恢复所选的 {n} 个配置项？': 'Confirm to restore the selected {n} config items?',
  '如果所选待恢复的配置文件已存在，那么现有配置文件将被覆盖。': 'If the selected config file to be restored already exists, the existing config file will be overwritten.',
  '如果所选待恢复的配置项已存在，那么现有配置项将被覆盖。': 'If the selected config item to be restored already exists, the existing config item will be overwritten.',
  ...
  '请先填写配置项 {n} 的值，然后再尝试导入': 'Please fill in the value of config item {n} first, and then try to import',
  '提示：': 'Tip:',
  ...
  绑定服务不能为空: 'The bound service cannot be empty',
  ...
  '筛选myservice服务下所有的配置(包含子目录)': 'Filter all configs under the myservice service (including subdirectories)',
  '筛选myservice服务/etc目录下所有的配置(不含子目录)': 'Filter all configs in the /etc directory of the myservice service (excluding subdirectories)',
  '筛选myservice服务/etc/nginx/nginx.conf文件': 'Filter the /etc/nginx/nginx.conf file of the myservice service',
  关联myservice服务下所有配置项: 'Associate all config items under the myservice service',
  关联myservice服务下所有以demo_开头的配置项: 'Associate all config items starting with demo_ under the myservice service',
  共有: 'There is',
  ...
  请输入配置项名称: 'Please enter the config item name',
  请输入配置文件名称: 'Please enter the config file name',
  ...
  '节点管理插件客户端用于非容器化应用程序 (传统主机) 拉取文件型配置场景。': 'The node management plug-in client is used in the non-containerized application (traditional host) pull-file config scenario',
  '命令行工具通常用于在脚本 (如 Bash、Python 等) 中手动拉取应用程序配置，同时支持文件型和键值型配置的获取。': 'Command line tools are commonly used to manually pull application config in scripts (such as Bash, Python, etc.), and support both file - and key-value config acquisition',
  ...
  '请先选择配置文件名，替换下方示例代码后，再尝试复制示例': 'Please select a config file name, replace the example code below, and then try copying the example',
  '请先选择配置项名称，替换下方示例代码后，再尝试复制示例': 'Please select the config item name first. After replacing the example code below, try to copy the example',
  ...
  Get方法: 'Get',
  Watch方法: 'Watch',
  'Get 方法：用于一次性获取配置项信息，适合在需要主动获取指定配置项的场景下使用。': 'Get Method: This method is used to retrieve config item information in a one-time manner, suitable for scenarios where there is a need to actively fetch specific config items',
  ...
  'Get 方法：用于一次性拉取配置文件内容，适合在需要主动拉取指定配置文件的场景下使用。': 'Get Method: This method is used to pull the contents of a config file in a one-time manner, suitable for scenarios where there is a need to actively retrieve a specific config file',
  ...
  '(即客户端密钥，需填写与此服务配置关联过的实际客户端密钥)': '(That is, client key, the actual client key associated with this service config must be filled in.)',
  配置指引与示例预览: 'Config guide and sample preview',
  ...
  '下载地址：': 'download url',
  '为命令行工具创建所需的配置文件bscp.yaml，请复制以下命令并在与该命令行工具相同的目录下执行': 'Create the necessary config file bscp.yaml for the command-line tool. Please copy the following command and execute it in the directory where the command-line tool resides',
  '为命令行工具创建所需的配置文件bscp.yaml': 'Create the necessary config file bscp.yaml for the command-line tool',
  ...
  '获取指定服务下指定配置项列表，支持多个配置项，配置项之间用空格分隔': 'Retrieve the list of specified config items under the specified service, supporting multiple config items separated by spaces',
  ...
  '下载配置文件时，保留目录层级，并将其保存到指定目录下，例如：将 {path} 文件下载到 /tmp 目录时，文件保存在 /tmp{path}': 'When downloading config files, preserve directory structure and save them to a specified directory. For example, downloading the file {path} to the /tmp directory would save it as /tmp{path}',
  '下载配置文件时，不保留目录层级，并将其保存到指定目录下，例如：将 {path} 文件下载到 /tmp 目录时，文件保存在 /tmp/{name}': 'When downloading config files, do not preserve directory structure and save them directly to a specified directory. For example, downloading the file {path} to the /tmp directory would save it as /tmp/{name}',
  '下载配置文件时，保留目录层级，并将其保存到指定目录下，例如：将 {path} 文件下载到当前目录时，文件保存在 .{windowsPath}': 'When downloading the config file, retain the directory structure and save it to a specified directory. For example, when downloading the {path} file to the current directory, it should be saved as .{windowsPath}',
  '下载配置文件时，不保留目录层级，并将其保存到指定目录下，例如：将 {path} 文件下载到当前目录时，文件保存在 .\\{windowsName}': 'When downloading the config file, do not retain the directory structure and save it to a specified directory. For example, when downloading the {path} file to the current directory, it should be saved as .\\{windowsName}',
  ...
  '请选择一个配置文件名，用于测试下载相应文件': 'Please select a config file name for testing the download of the corresponding file',
  '请选择一个配置项名称，用于测试下载相应文件': 'Please select a config item name for testing the download of the corresponding file',
  ...
  一键复制: 'Copy',
  启用配置文件筛选: 'Enable config file filtering',
  '当客户端无需拉取配置服务中的全量配置文件时，可以启用此功能，指定相应的通配符，可仅拉取客户端所需的文件': 'When the client does not need to pull the full config files from the config service, this feature can be enabled. By specifying the appropriate wildcard, the client can pull only the required files',
  已设置的筛选规则: '{count} filtering rules have been set',
  规则设置: 'Rule config',
  配置文件筛选规则: 'Config file filter rules',
  配置文件筛选: 'Config file filter',
  '全局配置文件筛选：': 'Global Config File Filter：',
  '全局配置文件筛选与服务配置文件筛选一样，不同的是全局配置文件筛选可供多个服务共用': 'The filtering of the global config file is the same as that of the service config file; the difference is that the global config file can be shared among multiple services',
  配置筛选规则: 'Config filtering rules',
  ...
  此SDK暂不支持method方法拉取配置文件: 'This SDK does not currently support the {method} method for pulling config files',
  全部配置项: 'All config items',
  'tRPC配置示例中的./trpc_go.yaml文件': 'The ./trpc_go.yaml file in the tRPC config example',
  ...
  托管: 'Managed',
  取消托管: 'Cancel Managed',
  '确认批量{n}所选进程？': 'Confirm {n} selected processes in batch?',
  '已选择 {n} 个进程，将立即{m}运行': '{n} processes selected, will {m} run immediately',
  ...
  体验: 'Experience',
  测试: 'Test',
  '确认{n}进程?': 'Confirm {n} processes?',
  进程别名: 'Process Alias',
  '将执行{n}命令': 'Will execute {n} commands',
  一键同步状态: 'One-click Sync Status',
  '数据同步中，请耐心等待刷新…': 'Data is syncing, please wait for refresh…',
  '最近一次同步：{n}': 'Last sync: {n}',
  查看进程配置: 'View Process Config',
  '内网IP/进程状态/托管状态/CC 同步状态': 'Internal IP / Process Status / Managed Status / CC Sync Status',
  集群: 'Cluster',
  模块: 'Module',
  ...
  更新托管信息: 'Update Managed Info',
  配置下发: 'Config Dispatch',
  主机下唯一标识: 'Unique Identifier under Host',
  模块下唯一标识: 'Unique Identifier under Module',
  全部进程将会进行重启: 'All processes will be restarted',
  '执行旧的停止命令，使用新的启动命令': 'Execute old stop command, use new start command',
  旧: 'Old',
  新: 'New',
  更新并重启: 'Update and Restart',
  '进程启动参数：': 'Process Start Parameters:',
  '工作路径：': 'Working Path:',
  'PID 路径：': 'PID Path:',
  '启动用户：': 'Start User:',
  '启动命令：': 'Start Command:',
  ...
  '强制停止：': 'Force Stop:',
  '重载命令：': 'Reload Command:',
  '启动等待时长：': 'Start Wait Duration:',
  '操作超时时长：': 'Operation Timeout Duration:',
  正常: 'Normal',
  已删除: 'Deleted',
  有更新: 'Updated',
  运行中: 'Running',
  ...
  托管中: 'Managed',
  未托管: 'Unmanaged',
  部分托管中: 'Partially Managed',
  '全部集群 (*)': 'All Clusters (*)',
  '全部模块 (*)': 'All Modules (*)',
  '全部服务实例 (*)': 'All Service Instances (*)',
  '全部进程 (*)': 'All Process (*)',
  '全部 process_id (*)': 'All process_id (*)',
  '内网 IP': 'Internal IP',
  '对应 CMDB 中唯一 ID': 'Unique ID in CMDB',
  启动: 'Start',
  停止: 'Stop',
  内网IP: 'Internal IP',
  ...
  // 配置模板管理
  配置模板管理: 'Config Template Management',
  高亮风格: 'Highlight Style',
  进程实例: 'Process Instance',
  请先选择进程实例: 'Please select a process instance first',
  类配置文件详情型: 'Config File Details',
  文件名称: 'File Name',
  文件路径: 'File Path',
  ...
  重试所有失败项: 'Retry All Failed',
  立即下发: 'Issue Immediately',
  选择范围: 'Select Range',
  配置生成: 'Config Generation',
  即将下发: 'Pending Issue',
  个已生成: 'Generated',
  个生成失败: 'Generation Failed',
  '已选{n}/{m}个版本': 'Selected {n}/{m} Versions',
  '根据配置模板历史版本，筛选对应的实例': 'Filter Instances by Template History',
  所属拓扑: 'Belonging Topology',
  版本ID: 'Version ID',
  重新生成: 'Regenerate',
  进程范围: 'Process Range',
  个模板进程: 'Template Processes',
  个实例进程: 'Instance Processes',
  关联进程实例: 'Associated Process Instances',
  选择关联进程: 'Select Associated Process',
  按业务拓扑: 'By Business Topology',
  按服务模版: 'By Service Template',
  请选择关联进程: 'Please select associated process',
  集: 'S',
  模: 'M',
  实: 'I',
  进: 'P',
  加载中: 'Loading',
  配置模板详情: 'Config Template Details',
  模板信息: 'Template Information',
  模板归属: 'Template Attribution',
  新建: 'Create',
  '模板名称/文件名/更新人': 'Template Name/File Name/Updated By',
  文件名: 'File Name',
  模板进程: 'Template Process',
  实例进程: 'Instance Process',
  立即关联: 'Associate Now',
  '未关联进程，无法进行配置下发': 'Cannot issue Config without associated process',
  '确认删除模板文件?': 'Confirm Delete Template File?',
  新建配置模板: 'Create Config Template',
  新建配置模板成功: 'Config Template Created Successfully',
