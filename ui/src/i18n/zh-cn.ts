export default {
  ...
  tips: {
    ...
    type: `任意格式：不对配置项的格式做限制。如果选择下方某个格式，则只能创建指定格式的配置项
         string：单行字符串
         number：数值，包含整数、浮点数、会校验数据格式
  ...
  请选择数据类型: '请选择数据类型',
  服务属性编辑成功: '服务属性编辑成功',
  '调整服务数据格式{n}失败': '调整服务数据格式{n}失败',
  '该服务下存在非{n}类型的配置项，如需修改，请先调整该服务下的所有配置项数据格式为{n}': '该服务下存在非{n}类型的配置项，如需修改，请先调整该服务下的所有配置项数据格式为{n}',
  关闭上线审批存在风险: '关闭上线审批存在风险',
  生产环境不建议关闭审批: '生产环境不建议关闭审批',
  审批流程可以提高配置更改的准确性和安全性: '审批流程可以提高配置更改的准确性和安全性',
  仍要关闭: '仍要关闭',
  配置格式限制: '配置格式限制',
  任意类型: '任意类型',
  编辑基本属性: '编辑基本属性',
  只显示我创建的服务: '只显示我创建的服务',
  '搜索 服务别名、服务名称、服务描述、创建人、更新人': '搜索 服务别名、服务名称、服务描述、创建人、更新人',
  启用: '启用',
  table_键值型: '键值型',
  服务列表: '服务列表',
  克隆服务: '克隆服务',
  ...
  创建项目成功: '创建项目成功',
  请输入项目名称: '请输入项目名称',
  '项目名称/项目描述/创建人': '项目名称/项目描述/创建人',
  '删除该项目后将无法恢复，请谨慎操作': '删除该项目后将无法恢复，请谨慎操作',
  ...
  请输入环境名称: '请输入环境名称',
  请输入环境描述: '请输入环境描述',
  环境名称只能包含英文字母: '环境名称只能包含英文字母',
  环境不能为空: '环境不能为空',
  '环境名称/环境描述/创建人': '环境名称/环境描述/创建人',
  '删除该环境后将无法恢复，请谨慎操作': '删除该环境后将无法恢复，请谨慎操作',
  '当前处于生产环境的配置管理，请谨慎操作以避免影响线上业务！': '当前处于生产环境的配置管理，请谨慎操作以避免影响线上业务！',
  '当前处于预发布环境的配置管理，与生产环境高度一致，请按生产标准进行验证！': '当前处于预发布环境的配置管理，与生产环境高度一致，请按生产标准进行验证！',
  '当前处于测试环境的配置管理，仅用于功能测试验证，数据可能会重置。': '当前处于测试环境的配置管理，仅用于功能测试验证，数据可能会重置。',
  '当前处于开发环境的配置管理，用于开发调试，服务可能不稳定。': '当前处于开发环境的配置管理，用于开发调试，服务可能不稳定。',
  ...
  已上线: '已上线',
  操作: '操作',
  只支持未上线和未待审批版本: '只支持未上线和未待审批版本',
  恢复: '恢复',
  删除: '删除',
  版本详情: '版本详情',
  '配置文件名/创建人/修改人': '配置文件名/创建人/修改人',
  '配置项名称/创建人/修改人': '配置项名称/创建人/修改人',
  新建配置文件: '新建配置文件',
  新建配置项: '新建配置项',
  手动新增: '手动新增',
  批量上传: '批量上传',
  ...
  已过时: '已过时',
  定时上线文案: '版本将于 {time} 上线',
  '需审批-定时上线文案': '上线审批通过后，版本将于 {time} 上线',
  '定时上线文案-调整分组': '调整分组上线版本将于 {time} 生效',
  '需审批-定时上线文案-调整分组': '上线审批通过后，调整分组上线版本将于 {time} 生效',
  ...
  删除服务: '删除服务',
  上线版本配置: '上线',
  '提示-待审批': '审批人（{approveType}）：{approver}',
  '上线操作人: ': '上线操作人: ',
  '上线时间: {n}': '上线时间: {n}',
  '上线说明: {n}': '上线说明: {n}',
  '提示-审批驳回': '审批已驳回\n审批人：{reviser}\n上线时间：{time}\n驳回原因：{reason}',
  ...
  操作成功: '操作成功',
  高频上线风险提示: '高频上线风险提示',
  '当前服务有正在上线的任务，请稍后尝试': '当前服务有正在上线的任务，请稍后尝试',
  近三次版本上线记录: '近三次版本上线记录',
  查看全部上线记录: '查看全部上线记录',
  上线时间: '上线时间',
  '正在上线的版本：': '正在上线的版本：',
  ...
  审批方式: '审批方式',
  未开启: '未开启',
  'ITSM 审批链接已复制！': 'ITSM 审批链接已复制！',
  '此单据已审批完成，无需进一步处理': '此单据已审批完成，无需进一步处理',
  '此单据已撤销，无需进一步处理': '此单据已撤销，无需进一步处理',
  审批单: '审批单',
  审批时间: '审批时间',
  驳回原因: '驳回原因',
  请输入驳回理由: '请输入驳回理由',
  无确认上线权限文案: '请联系服务上线提交人 {creator} 进行确认上线操作。\n如果无法联系到提交人，并且有紧急配置需要发布，可以执\n行“撤销上线”后重新提交服务上线流程',
  '进行确认上线操作。': '进行确认上线操作。',
  '如果无法联系到提交人，并且有紧急配置需要发布，可以执': '如果无法联系到提交人，并且有紧急配置需要发布，可以执',
  '行“撤销上线”后重新提交服务上线流程': '行“撤销上线”后重新提交服务上线流程',
  请联系服务上线提交人: '请联系服务上线提交人',
  审批版本详情: '审批版本详情',
  待上线分组: '待上线分组',
  版本已审批通过: '版本已审批通过',
  撤销说明: '撤销说明',
  ...
  启用密钥名称: '启用密钥名称',
  禁用密钥名称: '禁用密钥名称',
  关联服务配置密钥名称: '关联服务配置密钥名称',
  配置重新拉取客户端UID: '配置重新拉取客户端UID',
  配置重新拉取客户端IP: '配置重新拉取客户端IP',
  '对{n}等 {m} 个对象进行操作': '对{n}等 {m} 个对象进行操作',
  配置: '配置',
  模板: '模板',
  变量: '变量',
  客户端实例: '客户端实例',
  ...
  '输入格式不支持，请上传 X.509 证书或 RSA 私钥': '输入格式不支持，请上传 X.509 证书或 RSA 私钥',
  '此证书已于 {n} 过期，请尽快更换证书': '此证书已于 {n} 过期，请尽快更换证书',
  ...
  继续生成版本: '继续生成版本',
  证书即将过期: '证书即将过期',
  '请先填写配置项 {n} 的值，然后再尝试导入': '请先填写配置项 {n} 的值，然后再尝试导入',
  '提示：': '提示：',
  '如果要批量导入的敏感信息包含多行文本的证书（certificate）或自定义（custom），请使用JSON或YAML格式进行导入': '如果要批量导入的敏感信息包含多行文本的证书（certificate）或自定义（custom），请使用JSON或YAML格式进行导入',
  'RSA 私钥格式无效': 'RSA 私钥格式无效',
  证书和私钥: '证书和私钥',
  版本废弃成功: '版本废弃成功',
  '请选择/请输入': '请选择/请输入',
  ...
  设置: '设置',
  复制变量值: '复制变量值',
  '每行表示一个变量，包含变量名称、变量类型、默认值与描述（可选），默认使用空格分隔': '每行表示一个变量，包含变量名称、变量类型、默认值与描述（可选），默认使用空格分隔',
  '以 JSON 格式批量导入变量，变量名称作为 JSON 对象的 Key，而变量类型、默认值、描述组成一个嵌套对象，作为对应 Key 的 Value': '以 JSON 格式批量导入变量，变量名称作为 JSON 对象的 Key，而变量类型、默认值、描述组成一个嵌套对象，作为对应 Key 的 Value',
  '以 YAML 格式批量导入变量，变量名称作为 YAML 对象的 Key，而变量类型、默认值、描述分别作为嵌套对象的子键，形成对应键的值 ': '以 YAML 格式批量导入变量，变量名称作为 YAML 对象的 Key，而变量类型、默认值、描述分别作为嵌套对象的子键，形成对应键的值 ',
  '变量名称 变量类型 默认值 描述（可选）': '变量名称 变量类型 默认值 描述（可选）',
  '简单文本格式：': '简单文本格式：',
  ...
  移出套餐成功: '移出套餐成功',
  新建版本: '新建版本',
  '版本号/版本说明/创建人': '版本号/版本说明/创建人',
  '版本号/版本描述/创建人': '版本号/版本描述/创建人',
  选择载入版本: '选择载入版本',
  版本说明: '版本说明',
  展开列表: '展开列表',
  ...
  Get方法: 'Get方法',
  Watch方法: 'Watch方法',
  'Get 方法：用于一次性获取配置项信息，适合在需要主动获取指定配置项的场景下使用。': 'Get 方法：用于一次性获取配置项信息，适合在需要主动获取指定配置项的场景下使用。',
  ...
  'Get 方法：用于一次性拉取配置文件内容，适合在需要主动拉取指定配置文件的场景下使用。': 'Get 方法：用于一次性拉取配置文件内容，适合在需要主动拉取指定配置文件的场景下使用。',
  ...
  全部配置项: '全部配置项',
  'tRPC配置示例中的./trpc_go.yaml文件': 'tRPC配置示例中的./trpc_go.yaml文件',
  ...
  托管: '托管',
  取消托管: '取消托管',
  '确认批量{n}所选进程？': '确认批量{n}所选进程？',
  '已选择 {n} 个进程，将立即{m}运行': '已选择 {n} 个进程，将立即{m}运行',
  继续执行: '继续执行',
  表达式: '表达式',
  筛选: '筛选',
  正式:' 正式',
  ...
  '将执行{n}命令': '将执行{n}命令',
  一键同步状态: '一键同步状态',
  '数据同步中，请耐心等待刷新…': '数据同步中，请耐心等待刷新…',
  '最近一次同步：{n}': '最近一次同步：{n}',
  查看进程配置: '查看进程配置',
  '内网IP/进程状态/托管状态/CC 同步状态': '内网IP/进程状态/托管状态/CC 同步状态',
  集群: '集群',
  模块: '模块',
  服务实例: '服务实例',
  'CC 进程ID': 'CC 进程ID',
  ...
  主机下唯一标识: '主机下唯一标识',
  模块下唯一标识: '模块下唯一标识',
  全部进程将会进行重启: '全部进程将会进行重启',
  '执行旧的停止命令，使用新的启动命令': '执行旧的停止命令，使用新的启动命令',
  旧: '旧',
  新: '新',
  更新并重启:' 更新并重启',
  '进程启动参数：': '进程启动参数：',
  ...
  '全部服务实例 (*)': '全部服务实例 (*)',
  '全部进程 (*)': '全部进程 (*)',
  '全部 process_id (*)': '全部 process_id (*)',
  '内网 IP': '内网 IP',
  '对应 CMDB 中唯一 ID': '对应 CMDB 中唯一 ID',
  启动: '启动',
  停止: '停止',
  '内网IP': '内网IP',
  'CC 中更新了数量，已不存在这条实例记录，建议停止': 'CC 中更新了数量，已不存在这条实例记录，建议停止',
  前: '前',
  年: '年',
  月: '月',
  天: '天',
  ...
  // 任务历史
  任务历史: '任务历史',
  '任务对象/动作/执行账户/执行结果': '任务对象/动作/执行账户/执行结果',
  任务对象: '任务对象',
  进程: '进程',
  动作: '动作',
  环境类型: '环境类型',
  ...
  '任务ID': '任务ID',
  任务类型: '任务类型',
  '搜索 集群/模块/服务实例/进程别名/CC 进程 ID/Inst_id/内网 IP': '搜索 集群/模块/服务实例/进程别名/CC 进程 ID/Inst_id/内网 IP',
  'CC 进程 ID': 'CC 进程 ID',
  查看配置: '查看配置',
  等待执行: '等待执行',
  执行成功: '执行成功',
  ...
  个已生成: '个已生成',
  个生成失败: '个生成失败',
  '已选{n}/{m}个版本': '已选{n}/{m}个版本',
  '根据配置模板历史版本，筛选对应的实例': '根据配置模板历史版本，筛选对应的实例',
  所属拓扑: '所属拓扑',
  '版本ID': '版本ID',
  重新生成: '重新生成',
  进程范围: '进程范围',
  ...
  生成: '生成',
  下发: '下发',
  '任务正在执行，请稍候': '任务正在执行，请稍候',
  进程状态异常: '进程状态异常',
  尚未配置操作命令: '尚未配置操作命令',
  '前往 BKCC 配置': '前往 BKCC 配置',
  当前状态无需执行该操作: '当前状态无需执行该操作',
  '未下发配置，无法进行配置检查': '未下发配置，无法进行配置检查',
  立即执行: '立即执行',
  最后一次下发: '最后一次下发',
  检查结果: '检查结果',
  '进程已删除，无法操作': '进程已删除，无法操作',
  异常: '异常',
  无需更新托管信息: '无需更新托管信息',
  进程异常: '进程异常',
  '进程别名发生了变化，已自动在下方创建新进程。旧进程已删除，建议停止': '进程别名发生了变化，已自动在下方创建新进程。旧进程已删除，建议停止',
  一键清除已缩容的实例: '一键清除已缩容的实例',
  一键清除: '一键清除',
  '共 {n} 条实例记录待清除': '共 {n} 条实例记录待清除',
  '清除操作将对进程执行停止或者取消托管操作。': '清除操作将对进程执行停止或者取消托管操作。',
  清除: '清除',
  目标平台: '目标平台',
  个人设置: '个人设置',
  权限中心: '权限中心',
