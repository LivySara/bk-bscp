...
export const getProjectList = (biz_id: string, params: IProjectQuery) =>
  http.get(`/config/biz/${biz_id}/projects/list`, { params });
 ...
 * @returns
 */
export const updateProject = (biz_id: string, project_id: number, params: IProjectEditArg) =>
 ...
 * @returns
 */
export const deleteProject = (biz_id: string, project_id: number) =>
