...
import type { IEnvItem, IEnvQuery } from '../../types/env';
 ...
 * 创建环境
 */
export function createEnv(biz_id: string, project_id: string, data: Partial<IEnvItem>) {
 ...
 * 更新环境
 */
export function updateEnv(biz_id: string, project_id: string, env_id: string, data: Partial<IEnvItem>) {
