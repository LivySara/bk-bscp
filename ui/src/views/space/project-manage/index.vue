        ...
        <div class="table-wrapper">
          <bk-loading style="min-height: 300px" :loading="listLoading">
            <bk-table
              ...
              <bk-table-column :label="t('项目描述')" :min-width="200">
                <template #default="{ row }">{{ row.spec?.memo || '--' }}</template>
              </bk-table-column>
              <bk-table-column :label="t('环境数')" :width="80">
                <template #default="{ row }">
              ...
              <bk-table-column :label="t('创建人')" :width="120">
                <template #default="{ row }">{{ row.revision?.creator }}</template>
              </bk-table-column>
              <bk-table-column :label="t('创建时间')" :width="170">
